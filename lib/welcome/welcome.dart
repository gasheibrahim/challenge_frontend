      ...
      body: SingleChildScrollView(
        child: Column(children: [
          GFCard(
            ...
            content: const Text("Some quick example text to build on the card,Some quick example text to build on the card"),
            buttonBar: GFButtonBar(
              children: <Widget>[
                FloatingActionButton(
                  backgroundColor: GFColors.PRIMARY, // first FAB to perform decrement 
                  onPressed: () {
